...
import { useNoteTabId } from 'desktop/modules/space/_tabs/note/hooks/useNoteTabId';
import { noteTabStore } from 'desktop/modules/space/_tabs/note/lib/noteTabStore';
